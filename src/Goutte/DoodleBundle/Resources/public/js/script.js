...
//  var p = new doodleHolderPaperScope.Path(); //path.segments
//  p.add(new doodleHolderPaperScope.Point.random() * doodleHolderPaperScope.view.size);
//  p.add(new doodleHolderPaperScope.Point.random() * doodleHolderPaperScope.view.size);
//  p.add(new doodleHolderPaperScope.Point.random() * doodleHolderPaperScope.view.size);
//  p.add(new doodleHolderPaperScope.Point.random() * doodleHolderPaperScope.view.size);
//  p.strokeColor = 'green';
//  log (doodleHolderPaperScope, p);
//  doodleHolderPaperScope.view.draw();
//
//};
