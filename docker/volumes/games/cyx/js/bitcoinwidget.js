// SOURCE WAS HACKED TO OPTIMIZE THE PAGELOAD
// CSS moved to precompiled LESS
// HTML directly embedded in page
// Made sure it loads after jQuery
...
var CoinWidget = {
	...
	init: function(config){
      ...
      if (CoinWidget.config.instance) {
        CoinWidgetInstance = CoinWidget.config.instance;
      } else {
        CoinWidgetInstance++;
      }
